...
(use-package nano-theme
  ...
  (custom-set-faces
   `(flyspell-incorrect ((t (:underline (:color ,nano-dark-salient :style line)))))
   `(flyspell-duplicate ((t (:underline (:color ,nano-dark-salient :style line)))))

   `(git-gutter:modified ((t (:foreground ,nano-dark-salient))))
   `(git-gutter-fr:added ((t (:foreground ,nano-dark-popout))))
   `(git-gutter-fr:modified ((t (:foreground ,nano-dark-salient))))

   `(lsp-ui-doc-url:added ((t (:background ,nano-dark-highlight))))
   `(lsp-ui-doc-background:modified ((t (:background ,nano-dark-highlight))))

   `(vterm-color-red ((t (:foreground ,nano-dark-critical))))
   `(vterm-color-blue ((t (:foreground ,nano-dark-salient))))
   `(vterm-color-green ((t (:foreground ,nano-dark-popout))))
