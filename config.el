...
;; [[file:config.org::*Functions][Functions:2]]
(after! magit
   (magit-delta-mode +1))
...
;; +Selectric+ NK-Creams mode:1 ends here
...
;; [[file:config.org::*Embed Externally Linked Images][Embed Externally Linked Images:1]]
...
;; [[file:config.org::*LatexMK][LatexMK:1]]
