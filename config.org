...
+ A [[https://www.tug.org/texlive/][LaTeX Compiler]] is required for the mathematics rendering performed in [[https://orgmode.org/][org]],
  and that wonderful pdf/html export we have going. I recommend [[https://github.com/tectonic-typesetting/tectonic][Tectonic]] if you are new, this config uses XeLaTeX.
...
Harfbuzz is missing the beautiful ligatures,
...
And just some simple visual tweaks
#+begin_src emacs-lisp
