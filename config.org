...
*** Carbon
Recently I just fell in love with [[https://www.ibm.com/design/][IBM Design]]. The colors are contrasty but still subtle and distinctly IBM. This is my attempt to recreate that, in emacs

First step is to add some padding, line height, and just make things comfier
#+begin_src emacs-lisp
...
Now we can load the carbon modules themselves.
#+begin_src emacs-lisp
