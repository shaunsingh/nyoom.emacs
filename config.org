...
The author wrote a paper on this as well: https://arxiv.org/pdf/2008.06030.pdf
...
Instead of fundamental mode, =org-mode= seems much more useful
#+begin_src emacs-lisp
...
And because we use doom emacs, lets add some extra faces
#+begin_src emacs-lisp
(after! flycheck
...
** Basic configuration
Since I'm using tectonic, lets use mathjax to render tex previews.
#+begin_src emacs-lisp
